		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Mark.js Showcase",
									"targetURL": "#UI5MarkjsShowcase-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"UI5MarkjsShowcase-display": {
								"semanticObject": "UI5MarkjsShowcase",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=udina.sample.ui5mark",
									"url": sap.ui.require.toUrl("udina/sample/ui5mark")
								}
							}
						}
					}
